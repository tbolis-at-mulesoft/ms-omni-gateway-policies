# "a2a-pii-guard-policy" Policy Definition

This is the policy-definition half of the **A2A PII Guard** policy. It declares the GCL schema (`gcl.yaml`) and the Anypoint Exchange asset coordinates (`exchange.json`) that the implementation half (`../a2a-pii-guard-policy-flex/`) compiles against.
