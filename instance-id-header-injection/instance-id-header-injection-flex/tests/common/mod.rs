...
pub const POLICY_NAME: &str = "instance-id-header-injection-flex-v1-1";

// The header name injected by the policy.
pub const HEADER_NAME: &str = "x-anypoint-api-instance-id";

// Fallback value used by the policy when no API instance ID is available.
