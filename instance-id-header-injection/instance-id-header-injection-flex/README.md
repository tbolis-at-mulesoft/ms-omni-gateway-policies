...
> **Note:** Tests run with `--test-threads=1` because Docker compositions can flake under parallel execution.
...
definition_asset_id = { name = "instance-id-header-injection", version = "1.1.0-DEV" }
```
...
[package.metadata.anypoint]
group_id = "00000000-0000-0000-0000-000000000000"
definition_asset_id = { name = "instance-id-header-injection", version = "1.1.0" }
```
